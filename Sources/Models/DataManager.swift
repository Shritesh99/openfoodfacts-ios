...
protocol DataManagerProtocol {
    ...
    func addProductNutritionTable(_ product: Product, nutritionTable: [String: String], onSuccess: @escaping () -> Void, onError: @escaping (Error) -> Void)
...
class DataManager: DataManagerProtocol {
    ...
    func addProductNutritionTable(_ product: Product, nutritionTable: [String: String], onSuccess: @escaping () -> Void, onError: @escaping (Error) -> Void) {
        ...
        nutritionTable.forEach { (key: String, value: String) in
